...
class LogPage extends ListPage<LogItem> {
  ...
  late ToggleIcon dirIcon = ToggleIcon(value: true, on: Icons.arrow_upward_outlined.icon(), off: Icons.arrow_downward_outlined.icon(), onChanged: (e) => refreshItems());
  late ToggleIcon loadIcon = ToggleIcon(value: true, on: Icons.auto_mode.icon(), off: Icons.block.icon(), onChanged: (e) => refreshItems());
